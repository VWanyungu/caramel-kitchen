    ...
    recipes = [
      %{
        ...
        steps: [
          %{
            order: 1,
            instruction: "Blend tomatoes, scotch bonnet and half the onion until smooth."
          },
          %{
            order: 2,
            instruction: "Heat oil in a heavy-based pot. Fry remaining diced onion for 5 minutes."
          },
          %{
            order: 3,
            instruction: "Add tomato puree and fry for 3 minutes, stirring constantly."
          },
          %{
            order: 4,
            instruction:
              "Add blended tomato mixture. Cook on medium heat for 20 minutes, stirring often."
          },
          %{
            order: 5,
            instruction: "Add stock, bay leaves, curry powder and salt. Bring to a boil."
          },
          %{order: 6, instruction: "Wash rice and add to pot. Stir once, reduce to low heat."},
          %{
            order: 7,
            instruction:
              "Cover tightly with foil then lid. Cook for 30 minutes without lifting lid."
          },
      ...
      %{
        ...
        steps: [
          ...
          %{
            order: 2,
            instruction: "Heat olive oil in a wide pan. Sauté onion and pepper for 8 minutes."
          },
          %{
            order: 3,
            instruction: "Add garlic, cumin, paprika and chilli flakes. Cook 1 minute."
          },
          %{
            order: 4,
            instruction: "Pour in tomatoes. Season and simmer 10 minutes until thickened."
          },
          %{order: 5, instruction: "Make 4 wells in the sauce. Crack an egg into each well."},
          %{
            order: 6,
            instruction: "Cover and cook 5-7 minutes until whites are set but yolks remain runny."
          },
          %{
            order: 7,
            instruction:
    ...
    generated_recipes =
      Enum.map(3..30, fn i ->
        %{
          ...
          taste_tags:
            Enum.take_random(
              ["savory", "spicy", "tangy", "sweet", "umami", "mild", "bitter", "sour"],
              3
            ),
          dietary_flags:
            Enum.take_random(
              ["halal", "dairy_free", "gluten_free", "vegetarian", "vegan", "keto"],
              2
            ),
          allergens: [],
