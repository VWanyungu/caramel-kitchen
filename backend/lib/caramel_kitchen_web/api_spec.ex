  ...
  defmodule RecipeCard do
    ...
    OpenApiSpex.schema(%{
      ...
      properties: %{
        ...
        dish_categories: %Schema{type: :array, items: %Schema{type: :string}},
        course: %Schema{type: :string},
        meal: %Schema{type: :string, nullable: true},
        primary_method: %Schema{type: :string},
        difficulty: %Schema{type: :string, enum: ["beginner", "intermediate", "advanced"]},
        cuisine: %Schema{type: :string, nullable: true},
        cuisines: %Schema{type: :array, items: %Schema{type: :string}},
        cuisine_origin: %Schema{type: :array, items: %Schema{type: :string}},
        cost: %Schema{type: :number, nullable: true, description: "Estimated cost"},
        estimated_cost: %Schema{type: :number, nullable: true},
        servings: %Schema{type: :integer},
        serving_size: %Schema{type: :integer},
        cooking_time: %Schema{type: :integer},
        cooking_time_mins: %Schema{type: :integer},
        ...
        dietary_requirements: %Schema{type: :array, items: %Schema{type: :string}},
        ...
        access_level: %Schema{type: :string, enum: ["free", "premium"]},
        is_special: %Schema{type: :boolean},
        is_premium: %Schema{type: :boolean},
