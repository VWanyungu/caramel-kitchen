    ...
    >
      ...
      <div className="flex items-center justify-between gap-2.5 sm:gap-4">
        ...
        <button
          ...
          className={`relative w-16 h-16 sm:w-20 sm:h-20 rounded-full flex flex-col items-center justify-center cursor-pointer transition-all duration-200 select-none shrink-0 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white bg-white text-neutral-900 shadow-md scale-105 ring-1 ring-black`}
        >
          {/* Clock Face SVG Ticks */}
          <svg
            className="absolute inset-0 w-full h-full pointer-events-none"
